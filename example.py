...
elk_subsumers = elk.getSubsumers(margherita).toArray()
for i in range(len(elk_subsumers)):
    print(" - ", formatter.format(elk_subsumers[i]))
print("(",len(elk_subsumers)," in total)")
print()
...
hermit_subsumers = hermit.getSubsumers(margherita).toArray()
for i in range(len(hermit_subsumers)):
    print(" - ", formatter.format(hermit_subsumers[i]))
print("(",len(hermit_subsumers)," in total)")
print()
